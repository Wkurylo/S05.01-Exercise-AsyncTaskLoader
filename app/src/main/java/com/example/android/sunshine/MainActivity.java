...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final String SEARCH_QUERY_URL_EXTRA = null;
    private static final int WEATHER_SEARCH_LOADER = 1;
    private Bundle mQueryBundle = new Bundle();
    private LoaderManager mLoaderManager = getSupportLoaderManager();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQueryBundle.putString(SEARCH_QUERY_URL_EXTRA,SunshinePreferences.getPreferredWeatherLocation(this));

        mLoaderManager.initLoader(WEATHER_SEARCH_LOADER,mQueryBundle,this);
    }
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                URL weatherRequestUrl = NetworkUtils.buildUrl(searchQueryUrlString);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            mLoaderManager.restartLoader(WEATHER_SEARCH_LOADER,mQueryBundle,this);
            return true;
        }
